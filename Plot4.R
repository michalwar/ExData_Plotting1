...
data_dates$Global_reactive_power <- as.numeric(data_dates$Global_reactive_power)
...
data_dates$Voltage <- as.numeric(data_dates$Voltage)
...
plot(data_dates$Time, data_dates$Global_active_power, type = "l", 
     xlab = "", ylab = "Global Active Power (kilowatts)", cex=0.2)

plot(data_dates$Time, data_dates$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(data_dates$Time, data_dates$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
